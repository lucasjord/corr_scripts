...
parser.add_argument('--load', help='fitld data into AIPS and list scans (fitld)', action='store_true')
parser.add_argument('--calibrate', help='fringe fit data and find maser peak (fring)', action='store_true')
parser.add_argument('--plot', help='make some plots of spectra (possm)', action='store_true')
parser.add_argument('--delete', help='delete data in AIPS catalog (zap)', action='store_true')
args = parser.parse_args()

# Get the name of the experiment from the directory name.
...
if os.path.exists('/home/observer/correlations2/'+experiment+'/geo/'+experiment+'-geo.fits'):
    path_geo = '/home/observer/correlations2/'+experiment+'/geo/'
elif os.path.exists('/home/observer/correlations2/'+experiment+'/'+experiment+'-geo.fits'):
    path_geo = '/home/observer/correlations2/'+experiment+'/'
elif os.path.exists('/mnt/parallax/spirals/'+experiment+'/'+experiment+'-geo.fits'):
    path_geo = '/mnt/parallax/spirals/'+experiment+'/'
else:
    print "\nCannot find, experiment"+"-geo.fits in correlation or parallax folders. See --help.\n"

# Check if cont fits exists and define path.
if os.path.exists('/home/observer/correlations2/'+experiment+'/cont/'+experiment+'-cont.fits'):
    path_cont = '/home/observer/correlations2/'+experiment+'/cont/'
elif os.path.exists('/home/observer/correlations2/'+experiment+'/'+experiment+'-cont.fits'):
    path_cont = '/home/observer/correlations2/'+experiment+'/'
elif os.path.exists('/mnt/parallax/spirals/'+experiment+'/'+experiment+'-cont.fits'):
    path_cont = '/mnt/parallax/spirals/'+experiment+'/'
else:
    print "\nCannot find, experiment"+"-cont.fits in correlation or parallax folders. See --help.\n"

# Check if line fits exists and define path.
if os.path.exists('/home/observer/correlations2/'+experiment+'/line/'+experiment+'-line.fits'):
    path_line = '/home/observer/correlations2/'+experiment+'/line/'
elif os.path.exists('/home/observer/correlations2/'+experiment+'/'+experiment+'-line.fits'):
    path_line = '/home/observer/correlations2/'+experiment+'/'
elif os.path.exists('/mnt/parallax/spirals/'+experiment+'/'+experiment+'-line.fits'):
    path_line = '/mnt/parallax/spirals/'+experiment+'/'
else:
    print "\nCannot find, experiment"+"-line.fits in correlation or parallax folders. See --help.\n"
    sys.exit(0)
...
# Load data and some auxiliary files
if args.load == True or (args.load == False and args.calibrate == False and args.plot == False and args.delete == False):
    ...
    if os.path.exists('listr-geo.txt'):
        os.remove('listr-geo.txt')
    if os.path.exists('listr-cont.txt'):
        os.remove('listr-cont.txt')
    if os.path.exists('listr-line.txt'):
        os.remove('listr-line.txt')
    if os.path.exists('SU.txt'):
        os.remove('SU.txt')
    if os.path.exists('maser-spectrum.txt'):
        os.remove('maser-spectrum.txt')
